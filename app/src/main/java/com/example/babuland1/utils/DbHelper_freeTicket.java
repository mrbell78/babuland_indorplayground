...
public class DbHelper_freeTicket  extends SQLiteOpenHelper {



    private static final String TAG = DbHelper.class.getSimpleName();

    private static final String DATABASE_NAME = "Freeticket.db";
    private static final int DATABASE_VERSION = 1;
    Context context;
    SQLiteDatabase db;
    ContentResolver mContentResolver;

    public final static String TABLE_NAME = "qr_child_free";
    ...
    public DbHelper_freeTicket(Context context) {
    ...
    public boolean insertdata_free(String name, int total,int orderid,String status,String branchname){
